...
import { renderUserContent, formatTs, type MessageRenderer, type MessageRenderContext } from '../../app-sdk/messageRenderers'
...
export function createTranscriptRenderers(
  ...
  return [
    ...
    // identical content path (renderUserContent — paste chips included), one
    // prop different. Absent the flag no entry is emitted, so every other
