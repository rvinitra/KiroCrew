...
| [denial-differential.md](denial-differential.md) | The denial-differential gate: how a deny-rule change is proved not to newly refuse a golden path, and the `deny-diff-approved` escape hatch. |
